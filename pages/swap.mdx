...
- [Flow](../flow): to understand the different flows, the architecture, and how the trade is secured between the three parties (the user’s nano device, the Ledger Live back-end and the provider). 
- [How-to](../howto): to find out what needs to be done from the provider’s side in order to be integrated in Ledger Live, in the “Swap” section. It also provides detailled information about the different endpoints needed, as well as how to develop and test your LiveApp.
