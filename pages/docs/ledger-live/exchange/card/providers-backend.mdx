...
<Callout type="info" emoji="🔗">
  You will find all the information regarding the CARD endpoints here:
  https://exchange-integration-fund.redoc.ly/, as well as additional details on
  some endpoints below.
</Callout>

You need to implement following endpoint for the card: - To create a signed fund binary payload: [/sell](https://exchange-integration-fund.redoc.ly/#operation/postSell).
