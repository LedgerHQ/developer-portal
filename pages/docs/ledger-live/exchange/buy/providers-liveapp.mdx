...
- Respond to specific LiveApp URLs to adapt to the flow inside <Glossary word="Ledger Live"></Glossary>.
...
The LiveApp needs to respond to a URL with certain parameters. LiveApp URLs are used to open your LiveApp with the quote values that the user has already entered in <Glossary word="Ledger Live"></Glossary>.

- `accountAddress`: Destination address to deposit the crypto.
- `cryptoCurrency`: The <Glossary word="cryptocurrency"></Glossary> that the user wants to buy. It will contain the providerId value to identify the crypto.
...
- `language`: The language preference of the user set in <Glossary word="Ledger Live"></Glossary>.
- `theme`: The theme preference of the user set in <Glossary word="Ledger Live"></Glossary>.
