...
Test end-to-end your integration by manually loading your LiveApp through Developer Mode (see [Ledger Live Kit doc](../../../../docs/discover/dapp-browser/manifest#load-your-live-app-locally-on-desktop)) and submit:
