...
- [LiveApp](swap/providers-liveapp): details on your LiveApp specifities, such as the LiveApp URL, the Manifest or the use of Exchange SDK instead of the Ledger Live Kit.
