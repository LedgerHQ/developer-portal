---
title: Ledger Live Kit
description: Adding your currency in the Ledger Live Kit.
---
...
## Running the Ledger Live Kit project
...
## Adding the crypto in the Ledger Live Kit
...
4. In LL, you might need to create an adapter for your coin family to transform a WalletAPITransaction (the type of the transaction from the Ledger Live Kit point of view) to a Ledger Live Transaction (the type of the transaction from the Ledger Live point of view)
