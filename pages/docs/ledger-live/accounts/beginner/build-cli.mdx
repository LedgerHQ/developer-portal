...
Using a local version of <Glossary word="Ledger Live"></Glossary> to test your <Glossary word="integration"></Glossary> can be time consuming. If you would rather have a faster process, you can use the <Glossary word="CLI"></Glossary>.

## Set up

To install the <Glossary word="CLI"></Glossary> do:
...
You can test that your local Live Common and your device works correctly by executing a <Glossary word="CLI"></Glossary> command like:
...
<Callout type="info" emoji="ℹ️">
  Be aware that the <Glossary word="CLI"></Glossary> has some limitations compared to <Glossary word="Ledger Live"></Glossary>. For example, every sync with the <Glossary word="CLI"></Glossary> will sync the entire account history.
</Callout>
...
The one you will use the most before releasing you <Glossary word="integration"></Glossary> is:
...
- **00:00** <Glossary word="Ledger Live"></Glossary> Installation
- **00:38** <Glossary word="CLI"></Glossary> Build
- **01:20** <Glossary word="CLI"></Glossary> Usage