...
- Operation has the right <Glossary word="transaction"></Glossary> ID
- User can reach the <Glossary word="tx"></Glossary> details by clicking on the “view on explorer” button
