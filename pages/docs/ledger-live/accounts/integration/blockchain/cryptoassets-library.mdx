...
[@ledgerhq/cryptoassets](https://github.com/LedgerHQ/ledger-live/tree/develop/libs/ledgerjs/packages/cryptoassets) contains all definitions of cryptoassets that could be useful to Ledger Live.
...
<Callout>
  Find a reliable explorer. If you find more than one explorer, list them from
  most to less popular. Ledger Live will likely use the first explorer as
  default.
</Callout>
