...
To interact with <Glossary word="Ledger Live"></Glossary>, you'll need to configure the Ledger Services Kit. The first step is to install the necessary packages, and then set up the appropriate configuration through a transport layer named "Transport". This transport layer will enable communication with the Ledger Services Kit.
...
During the development and testing phases, the Ledger Services Kit simulator can help you develop without requiring to run <Glossary word="Ledger Live"></Glossary> in parallel.
