...
- `id` (string): The unique identifier of this account used internally by <Glossary word="Ledger Live"></Glossary> software
...
- `currency` (string): The associated <Glossary word="cryptocurrency"></Glossary> id of the Account
...
- `blockHeight` (number): Tracks the current <Glossary word="blockchain"></Glossary> block height
