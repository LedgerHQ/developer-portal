...
`Account` is a slightly modified subject of the Account type used by the <Glossary word="Ledger Live"></Glossary> platform
...
export type Account = {
  /**
   * The unique identifier of this account used internally by <Glossary word="Ledger Live"></Glossary> software
   */
  id: string;
  /**
  ...
  address: string;
  /**
   * The associated <Glossary word="cryptocurrency"></Glossary> id of the Account
   */
  currency: string;
  /**
  ...
  /**
   * Tracks the current <Glossary word="blockchain"></Glossary> block height
   */
...
type Currency = {
    ...
    ticker: string;
    decimals: number;
    family: "bitcoin" | "<Glossary word="ethereum"></Glossary>" | "algorand" | "crypto_org" | "ripple" | "cosmos" | "celo" | ... 10 more ... | "solana";
}
