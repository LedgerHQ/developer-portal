...
The Account Module allows you to interact with the user's accounts. You can list accounts, request an account, and verify account addresses on a Ledger device through <Glossary word="Ledger Live"></Glossary>.
...
Allows the user to verify an account's address on their Ledger device through <Glossary word="Ledger Live"></Glossary>.
