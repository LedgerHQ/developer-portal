...
The Simulator is a tool provided by Ledger that allows developers to test their application without interacting with the real <Glossary word="Ledger Live"></Glossary> application.

It provides a mock environment with a set of predefined responses for different Services Kit actions.
This enables you to develop and test your application safely.

## Target audience

This documentation and the Ledger Services Kit library are dedicated to developers building Live Apps that are intended to be embedded within a wallet implementing the Ledger Services Kit Server like [Ledger Live](https://www.ledger.com/ledger-live).

## Overview

The Ledger Services Kit Simulator library empowers you to:

- **Easily develop your <Glossary word="Live App"></Glossary> in the browser**: Establish a fake connection to the Simulator acting as a wallet implementing the Ledger Services Kit Server, like <Glossary word="Ledger Live"></Glossary> would do.

- **Test in more ways**: The simulator facilitate writing E2E, <Glossary word="integration"></Glossary> or unit tests, by allowing mocking any data used.
