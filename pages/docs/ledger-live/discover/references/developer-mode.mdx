...
Ensure that Ledger Live Desktop is installed on your computer. If you haven’t installed it yet, download it from the [official Ledger website](https://www.ledger.com/ledger-live). You will also need a Ledger device (Nano S or X) to access Ledger Live.
