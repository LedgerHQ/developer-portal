...
We offer a specific package to facilitate easy integration of the Ledger Services Kit:
...
To test the Ledger Services Kit without connecting to the Ledger Live App directly, you can use the
