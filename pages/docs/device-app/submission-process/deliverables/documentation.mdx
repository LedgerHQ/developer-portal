...
Your device app repository must have a `docs` folder in which you will document the APDUs and corresponding errors, taking example on the [Bitcoin App](https://github.com/LedgerHQ/app-bitcoin-new/blob/develop/doc/bitcoin.md).
...
- Short introduction: what the app does, what <Glossary word="crypto assets"></Glossary> it can manage, using what service. Who has developed it. Ledger Nano S, Nano X and Nano S Plus supported?
- Requirements: What’s needed before starting.
- Installation instructions: How to install the app using <Glossary word="Ledger Live"></Glossary>.
...
- Short introduction: what the app and service do, what <Glossary word="crypto assets"></Glossary> they can manage, why to use a Ledger device, where to get support.
- Requirements: What’s needed before starting.
- Installation instructions: How to install the app using <Glossary word="Ledger Live"></Glossary>.
- Setup instructions:
...
- How to send crypto assets
    ...
    - Explicitly instruct to verify <Glossary word="transaction"></Glossary> details on the device display, before confirming and signing it.
...
- **Referring to crypto assets**: name, <Glossary word="ticker"></Glossary>, <Glossary word="crypto asset(s), coin(s), cryptocurrency"></Glossary>.
