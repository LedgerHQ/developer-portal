...
- Short introduction: what the app does, what crypto assets it can manage, using what service. Who has developed it. 
...
- **Referring to the hardware wallet**: Ledger Nano S Plus, Ledger Flex, Ledger Stax, device, hardware wallet, Ledger hardware wallet, Ledger device.
