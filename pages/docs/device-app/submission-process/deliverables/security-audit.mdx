...
To be listed on the Ledger Live “My Ledger“ section, Device Apps and Plugins must go through our integration process that includes a security audit performed by one of our [trusted partners](../../getting-started#development-process-and-security-audit).

Provided your project fulfills the [conditions](#conditions), this is how an external audit unfolds:
1. You get in touch with the auditers and sign a contract with them. [Read more](../../getting-started#development-process-and-security-audit).
