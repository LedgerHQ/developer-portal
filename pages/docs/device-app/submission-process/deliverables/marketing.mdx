...
- @Ledger_Support will interact with the project's tweet if the Coin is below the top 100 by <Glossary word="market cap"></Glossary>.
- @Ledger will interact with the project's tweet if the Coin is in the top 100 by <Glossary word="market cap"></Glossary> or there is a co-branded partnership with the project


### Blog post / Press Release (optional)

If you choose to publish a blog post (or a press release) and the <Glossary word="Blockchain"></Glossary> is in top 50 CMC, the blog post can include a quote from Ledger's CEO, CTO, one of our Founders, or another c-level executive regarding the collaboration and the impact it will have on your project.
...
<Callout type="warning" emoji="⚠️">
  Co-branded partnerships or affiliate links do <b>not change</b> the Ledger <Glossary word="marketing plan"></Glossary> timeline.
</Callout>
