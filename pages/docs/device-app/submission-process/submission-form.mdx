...
The submission of a Ledger <Glossary word="device app"></Glossary> is completed through a form. This will ask you for all the various items required together in one place.
...
<Callout type="warning" emoji="⚠️">
    The <Glossary word="integration"></Glossary> process will only start if you answer accurately to all the questions.
</Callout>


## App Form Checklist

This section is a summary outline of what is needed in the process od developing a <Glossary word="device app"></Glossary>. The list below is organised by category and some items are quite varied.
...
- If your <Glossary word="blockchain"></Glossary> is not in <Glossary word="Ledger Live"></Glossary> yet and you modified the `Transfer` or `Verify address` flow: explanation about your modifications
...
- Two icons for the Ledger Stax, Nano and for "My Ledger" in <Glossary word="Ledger Live"></Glossary>, in PNG or GIF
...
- <Glossary word="Marketing plan"></Glossary> (optional)
