...
- I have met the [security requirements](../integration/requirements/security)
...
- I have read the integration walkthroughs
...
- The App has a [Blind Signing](../integration/requirements/security#signing-settings) setting (if applicable)
