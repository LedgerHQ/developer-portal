...
<Callout type="info" emoji="👉">
  See the <a href='../low-level-display-management/' class='alert-link'> BAGL Toolkit </a> for more information on the BOLOS Application Graphics Library technical details.
</Callout>
