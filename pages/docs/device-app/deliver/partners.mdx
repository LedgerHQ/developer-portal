...
build an application, load it on a device or on the Speculos emulator, and test your application with Ragger. Get
started [here](../develop/tutorials/).


## Security audit: your agreement with our partners

If your device app is ready to go through the security audit, you can contact one of our partners:
