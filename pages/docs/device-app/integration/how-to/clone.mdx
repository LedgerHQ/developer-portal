...
A variant, or clone, <Glossary word="device app"></Glossary> is developed when all the logic for signing transactions can be contained in the parent coin <Glossary word="Device Application"></Glossary>.

As for any <Glossary word="Device Application"></Glossary>, you must follow our guidelines to comply with Ledger publication requirements.

On this page you will find the information for Bitcoin and <Glossary word="Ethereum"></Glossary> clones.
...
If your Bitcoin clone was included in the Bitcoin <Glossary word="Device App"></Glossary> and you need to update it, you should
...
your <Glossary word="CI"></Glossary> is green and you should be good to go !
...
When your application is ready, open a pull request on the <Glossary word="Ethereum"></Glossary> application repository.
...
<Callout type="warning" emoji="⚠️">
  If your chain does not use the `44/60` path, you won't be able to use Metamask with your <Glossary word="device app"></Glossary>.
</Callout>
...
<Callout type="error" emoji="🚨">
    It is necessary to choose a Derivation Path and a Chain ID specific to your network to prevent the risk of replay attack (Introduced by EIP155) that can happen when using the same Derivation Path ( m/44'/60'/0') and Chain ID as <Glossary word="Ethereum"></Glossary>. This could expose your users to loss of funds.<br/>
