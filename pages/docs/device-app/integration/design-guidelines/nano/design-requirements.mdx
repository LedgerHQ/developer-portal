...
<Callout type="info" emoji="ℹ️">
  See the <a href='./low-level-display-management/' className='alert-link'> BAGL Toolkit </a> for more information on the Ledger OS Application Graphics Library technical details.
</Callout>
...
- a <Glossary word="validation"></Glossary> symbol to accept 
...
In the "Settings" section, follow this flow: <Glossary word="Blind signing"></Glossary> (if applicable) → Debug data (if applicable) → <Glossary word="Nonce"></Glossary> (if applicable) → Back
