...
For some operations, your app may not be able to fully load the data in memory before presenting it to your users. When streaming <Glossary word="transaction"></Glossary> data to your app device page by page, the navigation has to change
...
Here’s what an EIP-712 streamed message looks like in the <Glossary word="Ethereum"></Glossary> app, for Ledger Stax and Ledger Flex:
...
<Callout type="warning" emoji="⚠️">
  Try avoiding <Glossary word="transaction"></Glossary> streaming in your app whenever possible, since blocking your users in a forward-only progression is not recommended <Glossary word="UX"></Glossary>.
</Callout>
...
<Callout emoji="💻">
	<b>API</b><br/>
	There’s no specific graphical <Glossary word="API"></Glossary> to display this “More” button. It is handled automatically by the <code>nbgl_useCaseReview()</code> and <code>nbgl_useCaseReviewStreamingContinue()</code> functions.
</Callout>
