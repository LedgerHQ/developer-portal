...
If you’re developing your app using Ledger’s high-level APIs and standard <Glossary word="transaction"></Glossary> templates, then it will already conform to these design guidelines.
...
Your app’s UI will be automatically adapted to the device model you target when building your app, dynamically adjusting the size, elements, and number of pages. This works best if you use the high-level <Glossary word="API"></Glossary> endpoints known as “use cases”. 

Throughout these guidelines, the <Glossary word="API"></Glossary> endpoints will be linked within “API” sections like this:
