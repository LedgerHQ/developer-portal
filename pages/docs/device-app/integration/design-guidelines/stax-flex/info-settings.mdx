...
Settings must always appear before the app’s info, as illustrated by the <Glossary word="Ethereum"></Glossary> app example below. Navigation arrows are automatically introduced to split sections on their respective pages.
