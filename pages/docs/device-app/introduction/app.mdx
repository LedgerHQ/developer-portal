...
The Ledger Manager is the service which centralizes the distribution of [BOLOS](../architecture/bolos) applications on Ledger devices. It is the place where both Ledger’s apps and third party apps are distributed to users.
