...
![End-to-end architecture of a BOLOS application](/device-app/app_architecture.png)
...
The Ledger Manager is the service which centralizes the distribution of [BOLOS](./ledger-os/introduction) applications on Ledger devices. It is the place where both Ledger’s apps and third party apps are distributed to users.
