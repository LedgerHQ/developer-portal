---
title: "Speculos Emulator: How to send APDUs"
description: Clients can communicate with the emulated device using APDUs, as usual. Speculos embbeds a TCP server to forward APDUs to the target app.
---
