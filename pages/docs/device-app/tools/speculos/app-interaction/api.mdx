---
title: "Speculos Emulator: REST API"
description: A REST API is available at http://127.0.0.1:5000 when speculos is running. This API is meant to be used in test environments to automate actions on the device.
---
...
- Taking screenshot
- Pressing buttons
- Setting or updating [automation rules](../advanced-usage/automation.md)
- etc.
...
![screenshot btc nano s](/device-app/screenshot-api-nanos-btc.png)