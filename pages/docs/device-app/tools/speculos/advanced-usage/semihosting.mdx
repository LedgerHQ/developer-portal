---
title: "Speculos Emulator: Semihosting as an additional debug mechanism"
description: QEMU implements some semihosted operations which can be triggered from the app.
---
