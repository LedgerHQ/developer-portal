---
title: "Speculos Emulator: Automation"
description: The --automation argument allows to apply a set of actions when a condition is met. It is especially useful to automate app testing.
---
