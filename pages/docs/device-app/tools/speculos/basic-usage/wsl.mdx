...
description: Installation and basic usage for Windows users.
---

# Windows users (with WSL 2)

Building in WSL 2 (Windows Subsystem for Linux 2) is identical to the procedure in [building](./linux#build).
