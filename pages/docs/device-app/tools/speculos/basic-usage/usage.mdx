...
description: Basic usage of the Ledger devices emulator.
---
...
The docker image can also be used directly, as detailed in the specific [docker documentation page](./docker.mdx).
