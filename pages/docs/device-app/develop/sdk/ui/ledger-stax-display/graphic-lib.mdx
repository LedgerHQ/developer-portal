...
The library for handling the graphical aspects of your Device App on Stax is called [NBGL](https://github.com/LedgerHQ/ledger-secure-sdk/tree/master/lib_nbgl). The NBGL Engine is responsible for constructing screens and handling Touchscreen input. 
