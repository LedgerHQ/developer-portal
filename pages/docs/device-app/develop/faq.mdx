...
| How can I load an app without Ledger Live on my ledger nano S or S+?  | Here are the links [to the documentation](./tutorials/quickstart#build--load-an-application). |
