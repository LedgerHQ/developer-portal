...
<Cards num={2}>
  <Card
    title="A - Using the 44/60 path"
    href="#a---using-the-4460-path"
  />
  <Card
    title="B - All other paths"
    href="#b---all-other-paths"
  />
</Cards>
...
Add your 64x64px gif icon in the `glyphs` folder following this naming convention: `stax_chain_yourchainid_64px.gif`.
