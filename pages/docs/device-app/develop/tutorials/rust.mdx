...
<Callout type="info">
Stax support is not ready yet and should be available later.
</Callout>
...
Three of them are <u>mandatory</u> to submit your device application for review:
...
the app and then runs functional tests using the [Ragger](https://github.com/LedgerHQ/ragger) framework upon [Speculos](https://github.com/LedgerHQ/speculos) 
emulation. 
