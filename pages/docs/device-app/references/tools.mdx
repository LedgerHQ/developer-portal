...
2. Enter in recovery mode on your Ledger Nano S Plus. Do this by unplugging it then holding down the left button while plugging it in again. A menu appears and includes the `recovery mode` option. Enter your pin and continue.
...
1. Enter in recovery mode on your Ledger Nano S Plus: unplug the device and then plug it back while holding down the left button.A menu appears and includes the `recovery mode` option. Enter your pin and continue.
