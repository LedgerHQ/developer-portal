...
<Cards num={2}>
  ...
  <Card
    ...
    href="/docs/embedded-app/how-to-have-an-app/requirements/submission-form"
  />
</Cards>
...
- Two icons for the Ledger Stax, Nano and for "My Ledger" in Ledger Live, in PNG or GIF (see [Icons](../icons/))
