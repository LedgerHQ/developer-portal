...
<Callout type="warning" emoji="⚠️">
    <ul>
        <li>
            The following workflows are required on every embedded app repository, and must run without error.
        </li>
        <li>
...
[Speculos](../../how-to-develop/tools#speculos) emulator. These tests must be triggered by the CI and running without error.
