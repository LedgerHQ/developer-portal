...
See the complete submission flow [here](./how-to-deploy/process).
...
Ensure that you have a clear understanding of the [Process](./how-to-deploy/process) and are able to meet the [Requirements](./how-to-deploy/requirements) listed here.
...
- Know about the [Ledger Framework](./how-to-develop/tutorials/quickstart) and all the [environment tools](./how-to-develop/tools)
- Know how to test your application, using either a physical device or the [Speculos emulator](./how-to-develop/tools#speculos)
