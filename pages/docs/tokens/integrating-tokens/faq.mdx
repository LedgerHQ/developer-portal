...
| I want to add a coin, not a token.  | In that case you should go to the [Blockchain support section](../../blockchain-support/). If you are not a developer and the coin you are looking for is not supported, ask the Blockchain project team to do the integration. | 
