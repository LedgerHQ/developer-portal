...
<Callout type="info" emoji="ℹ️">
	<ul>
		<li>- If your NFT's metadata are immutable (non-editable), check out <a href='./metadata-tool'>this page</a>.</li>
		<li>- Make sure that the dedicated secondary image of your NFT meets <a href='./image-requirements'>the Ledger Stax’s image requirements</a>.</li>
	</ul>
</Callout>
