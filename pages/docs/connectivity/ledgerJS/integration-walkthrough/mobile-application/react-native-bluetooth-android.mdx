...
<Callout>
  For more information about enabling the developer settings on your android device go to <a href='https://developer.android.com/studio/debug/dev-options' className='alert-link'> android studio docs </a>.
</Callout>
