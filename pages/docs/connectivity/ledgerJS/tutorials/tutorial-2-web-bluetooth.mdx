...
<div className="center">
  <figure>
    ...
    <br/>
    <img src="/connectivity/ledger-blind-signing.png" alt="Nano Blind Signing alert"/>
    <br/>
...
<div className="center">
  <figure>
    ...
    <br/>
    <img src="/connectivity/ledger-tx-network.png" alt="Nano Network Screen"/>
...
![Sepolia Etherscan](/connectivity/tutorial-2-etherscan1.png)    
*Fig. 15: Sepolia Etherscan*

Wait till the status passes to Success.

![Sepolia Etherscan](/connectivity/tutorial-2-etherscan2.png)    
