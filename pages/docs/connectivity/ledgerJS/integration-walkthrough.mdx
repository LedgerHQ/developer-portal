...
Now that node and npm are installed, you have to install the [Ledger Live](https://www.ledger.com/docs/download) desktop application to connect your Ledger device.
