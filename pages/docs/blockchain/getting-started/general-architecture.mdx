...
The [Coin Framework](https://github.com/LedgerHQ/docs/tree/develop/libs/coin-framework) library is dedicated to coin integration. It provides utilities to help create Coin Modules with generic functions and a common interface signature.

#### Live Common

The Common library of Ledger Live is called [Ledger-live-common](https://github.com/LedgerHQ/docs/tree/develop/libs/ledger-live-common). It provides a single library compatible with both desktop and mobile version of Ledger Live.

#### Communication with the Device

[ledgerjs](https://github.com/LedgerHQ/docs/tree/develop/libs/ledgerjs) is a set of packages. It allows a JavaScript
