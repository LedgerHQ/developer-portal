...
<Callout type="info" emoji="ℹ️">
  This above file is automatically generated at build time by this script. It should not be updated manually but you should still check that your adapter is included in this file once added.
</Callout>
