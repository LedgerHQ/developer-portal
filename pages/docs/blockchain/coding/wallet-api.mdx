...
4. In `packages/core/src/families/{COIN_FAMILY}/types.ts` define and export types related to your type. At minimum, a [`{COIN_FAMILY}Transaction`](https://developers.ledger.com/APIs/wallet-api/appendix/transaction) and a [`Raw{COIN_FAMILY}Transaction`](https://developers.ledger.com/APIs/wallet-api/appendix/transaction#raw-transactions)
