...
The [@ledgerhq/cryptoassets](https://github.com/LedgerHQ/docs/tree/develop/libs/ledgerjs/packages/cryptoassets) package contains all definitions of cryptoassets that could be useful to Ledger Live.
...
All types can be found in [@ledgerhq/cryptoassets/src/types.ts](https://github.com/LedgerHQ/docs/blob/develop/libs/ledgerjs/packages/cryptoassets/src/types.ts)
...
In live-common, our formatter is implemented by [`formatCurrencyUnit`](https://github.com/LedgerHQ/docs/tree/develop/libs/ledger-live-common/src/currencies/formatCurrencyUnit.js) which takes a BigNumber value and a Unit (and many other options available).
...
Ensure that before integrating your coin to Ledger Live, your coin is well defined in [`@ledgerhq/cryptoassets/src/currencies.js`](https://github.com/LedgerHQ/docs/blob/develop/libs/ledgerjs/packages/cryptoassets/src/currencies.ts)
