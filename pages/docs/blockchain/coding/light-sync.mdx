...
Generic types can be found in [ledgerjs/packages/types-live](https://github.com/LedgerHQ/docs/tree/develop/libs/ledgerjs/packages/types-live), with some documentation.
...
All main accounts share a common ground, that you will find defined and commented [here](https://github.com/LedgerHQ/docs/blob/develop/libs/ledgerjs/packages/types-live/src/account.ts).
...
They all share the same model, with an `extra` field that can store any additional data you may need to display. You will find the detailed and commented fields [here](https://github.com/LedgerHQ/docs/blob/develop/libs/ledgerjs/packages/types-live/src/operation.ts).
...
There are more types available, existing one will have predefined icons, translations and behaviours (i.e. `getOperationAmountNumber()` in [src/operation.ts](https://github.com/LedgerHQ/docs/blob/develop/libs/ledgerjs/packages/types-live/src/operation.ts)).
...
See existing implementations for inspiration: [Polkadot types](https://github.com/LedgerHQ/docs/tree/develop/libs/ledger-live-common/src/families/polkadot/types.ts), [Cosmos types](https://github.com/LedgerHQ/docs/tree/develop/libs/ledger-live-common/src/families/cosmos/types.ts)
...
See [Polkadot Coin Integration's api](https://github.com/LedgerHQ/docs/tree/develop/libs/ledger-live-common/src/families/polkadot/api) for good inspiration.
...
We have a [`src/cache.ts`](https://github.com/LedgerHQ/docs/tree/develop/libs/coin-framework/src/cache.ts) helper for creating Least-Recently-Used caches anywhere if needed.

See for example the [Polkadot's cache usage](https://github.com/LedgerHQ/docs/tree/develop/libs/coin-polkadot/src/api/index.ts).
...
See examples like sorting and filtering validators, subscribing to preloaded data observable, or waiting for a transaction to be reflected in account, in the [Polkadot React hooks](https://github.com/LedgerHQ/docs/tree/develop/libs/ledger-live-common/src/families/polkadot/react.ts).
