...
From step 3 to step 6, you work will be implemented in the [Ledger Live repository](https://github.com/LedgerHQ/docs/tree/develop/libs/ledger-live-common).
...
Make changes to [`libs/ledger-live-common/src/derivation.ts`](https://github.com/LedgerHQ/docs/tree/develop/libs/ledger-live-common/src/derivation.ts):
...
See [Derivation documentation](https://github.com/LedgerHQ/docs/wiki/LLC:derivation) for further details.
