...
These bindings can either be implemented directly into live-common (as a folder in your coin family folder), or published in [LedgerJS/packages](https://github.com/LedgerHQ/docs/tree/develop/libs/ledgerjs) as a package - i.e. `hw-app-mycoin`.
...
You can find many implementations (`hw-app-*`) in [LedgerJS](https://github.com/LedgerHQ/docs/tree/develop/libs/ledgerjs/packages)
