...
The technical description of the bot in the Ledger Live repo, [here](https://github.com/LedgerHQ/docs/wiki/LLC:bot).  

The only tests needed are "Send 50%" and "Send max". Together these cover all the functions required, as seen [here](https://github.com/LedgerHQ/docs/wiki/LLC:bot#test-expectations).  The two tests are in the code below.  
