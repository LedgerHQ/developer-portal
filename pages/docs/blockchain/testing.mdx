...
The technical description of the bot in the Ledger Live repo, [here](https://github.com/LedgerHQ/ledger-live/wikiLLC:bot).  

The only tests needed are "Send 50%" and "Send max". Together these cover all the functions required, as seen [here](https://github.com/LedgerHQ/ledger-live/wikiLLC:bot#test-expectations).  The two tests are in the code below.  
...
You can find the full list of available parameters [here](https://github.com/LedgerHQ/docs/blob/develop/libs/ledger-live-common/src/bot/types.ts) for AppSpec and MutationSpec.
