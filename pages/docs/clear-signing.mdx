...
- If you work on a DApp or a wallet and want to follow the new Clear Signing initiative, [read this documentation](./eip7730)
- If you work on a DApp and want add EIP-712 messages Clear Signing support, [read this documentation](./eip712)
