...
| Design          | Follow the <a href="../../device-app/design-requirements">Embedded app design requirements.</a>               |
| Documentation   | Follow the <a href="../../device-app/documentation-requirements">Embedded app documentation requirements.</a> |
| Support         | Follow the <a href="../../device-app/support-requirements">Embedded app support requirements.</a>             |
| Security Audits | Follow the <a href="../../device-app/security-audit">Embedded app security audits requirements.</a>           |
