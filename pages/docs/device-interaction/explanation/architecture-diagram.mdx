...
You need to integrate at least the Device Management Kit in order to discuss with the Ledger device.
...
![Application Sequence Diagram](/connectivity/application-sequence.png)
