...
Now you can install the Ethereum and bitcoin application into your Ledger Nano X/S Plus, as in the tutorials and walkthroughs, we will use the Ethereum and Bitcoin application.
...
- Launch the Bitcoin application on your Ledger Nano X/S Plus
