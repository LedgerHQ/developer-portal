    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <center>
              <a href="environment-setup#android-studio">Android Studio</a>
            </center>
          </td>
          <td>
            <center>
              <a href="environment-setup#xcode">Xcode</a>
            </center>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <center>
              <a href="environment-setup#install-homebrew">Homebrew</a>
            </center>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <center>
              <a href="environment-setup#install-watchman">Watchman</a>
            </center>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <center>
              <a href="environment-setup#install-java-jre-and-jdk">
                Java JRE and JDK
              </a>
            </center>
          </td>
        ...
        <tr>
          ...
          <td colspan="2">
            <center>
              <a href="environment-setup#install-react-native">React Native</a>
            </center>
          </td>
        </tr>
      </tbody>
