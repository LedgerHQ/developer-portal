...
In this section, we will guide you through the creation of a web application. This application will connect to your Nano and will display the “test“ message to be signed with an <Glossary word="Ethereum"></Glossary> account using the personal sign message functionality introduced by EIP-191.
...
- Install or update your <Glossary word="Ethereum"></Glossary> <Glossary word="Embedded App"></Glossary> to the version 1.9.19 or later.
...
<Callout type="warning" emoji="⚠️">
  Comment out or remove the Transport package you are not using (<code>@ledgerhq/hw-transport-webusb</code> or <code>@ledgerhq/hw-transport-webhid</code>) and the corresponding <code>const</code>. In the example, we use webusb. Webhid is already commented in line 8 and line 23.
</Callout>
...
const initial = "<h1>Connect your Nano and open the <Glossary word="Ethereum"></Glossary> app. Click on “Hash my message”</h1>";
...
Before clicking on the “Hash my message”, connect your Nano to the USB port, unlock it and run the <Glossary word="ethereum"></Glossary> application. Then, click on “Hash my message”.
...
Click the right button to see the content of the message that you are going to sign with your <Glossary word="Ethereum"></Glossary> address:
...
- The <Glossary word="Ethereum"></Glossary> address used to sign the message
...
2. Run your code, it should now display the <Glossary word="Ethereum"></Glossary> address linked to the signed message (the run can take a bit of time):

<Zoom>
  <img
    alt="Runkit"
    src="/device-interaction/runkit-verification.png"
  />
</Zoom>
