...
To implement the Ledger connexion you will only modify "App.js", "index.js", "ConnectLedger.js”,"SmartContract.js", and <Glossary word="ethereum"></Glossary>.js”
...
In "SmartContract.js", copy-paste the following code and replace `{YOUR_INFURA_APIKEY}` by the <Glossary word="API"></Glossary> key you will find on your Infura account:
...
function SmartContract({eth,address}) {
  ...
  const updateData = async e => {
    ...
    //Serialize the same <Glossary word="transaction"></Glossary> as before, but adding the signature on it
...
Before clicking on the button, unlock your Nano X and run the <Glossary word="Ethereum"></Glossary> application.
...
<Callout type="warning" emoji="⚠️">
  For the tutorial to work, go to the <Glossary word="Ethereum"></Glossary> app settings and enable <Glossary word="Blind Signing"></Glossary>.
</Callout>
...
<div className="center">
  <figure>
    ...
    <figcaption><i>Fig. 10: <Glossary word="Blind Signing"></Glossary> info Screen</i></figcaption>
...
<Callout type="warning" emoji="⚠️">
  For the Smart Contract call you need to allow <Glossary word="blind signing"></Glossary> because the smart contract that is called in the tutorial is not yet verified and reviewed by Ledger. But if the smart contract you are calling is accepted by Ledger do not enable <Glossary word="blind signing"></Glossary>. Moreover, we do not recommend enabling <Glossary word="blind signing"></Glossary> in other situations as the main purpose to sign with Ledger is the 'Sign what you see' system. And by enabling <Glossary word="blind signing"></Glossary> it can not ensure that what you see is what you get.
</Callout>


### Review the Transaction on Sepolia Etherscan
By updating the data a <Glossary word="transaction"></Glossary> is created to change this data, it can be verified on Sepolia Etherscan.
