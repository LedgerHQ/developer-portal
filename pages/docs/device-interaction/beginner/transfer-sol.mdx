...
## Introduction
In this section, we will guide you through the creation of an application. This application will create a <Glossary word="transaction"></Glossary> that will be signed with the Ledger Nano before sending it to the <Glossary word="blockchain"></Glossary>.
        ...
        <div class="modal-content">
          ...
          <div class="modal-body d-flex justify-content-center">
            <button id="connect-ledger" class="rounded-3 align-self-center" data-bs-dismiss="modal">
              <img src="./assets/ledger-logo.png" class="card-img-top" alt="Ledger">
            </button>
          </div>
        </div>
      </div>
...
document.getElementById("tx-transfer").onclick = async function () {
    ...
    try {
        ...
        const <Glossary word="transaction"></Glossary> = new SolanaWeb3.Transaction({ feePayer: addressWallet, recentBlockhash: recentBlockhash.blockhash}).add(
        ...
        const unsignedTx = <Glossary word="transaction"></Glossary>.serializeMessage();

        //Sign with the Ledger Nano (Sign what you see)
        const { signature } = await _sol.signTransaction("44'/501'/0'", unsignedTx);
        <Glossary word="transaction"></Glossary>.addSignature(addressWallet,signature);

        //Serialize the same <Glossary word="transaction"></Glossary> as before, but added the signature on it
        const signedTx = <Glossary word="transaction"></Glossary>.serialize();
...
<div className="center">
  <figure>
      <img src="/device-interaction/ledgerCodePin.jpg" alt="Ledger Enter Code Pin"/>
...
<div className="center">
  <figure>
      <img src="/device-interaction/ledgerSol.jpg" alt="Run Solana Application on Ledger Nano"/>
...
After connecting the Nano, click on "Get Information". If all goes well, the input fields will be filled with data. The greyed input is not to be changed and it is directly extracted either from the <Glossary word="blockchain"></Glossary> or from your Ledger Embedded application.
...
When the <Glossary word="transaction"></Glossary> proceed and finalize, an URL will be displayed on the screen. This URL is a link to Solana Explorer to review the <Glossary word="transaction"></Glossary>.  
...
*Fig. 11: <Glossary word="Transaction"></Glossary> Information URL*

If you go on Solana Explorer you can see the information of your <Glossary word="transaction"></Glossary>.
