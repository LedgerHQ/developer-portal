...
- creates a <Glossary word="transaction"></Glossary> 
- signs it using the Ledger Nano then 
- sends it to the <Glossary word="blockchain"></Glossary>.  

The purpose of the application is to transfer ethers from your <Glossary word="ethereum"></Glossary> account on your Ledger to another account.
...
- Create an <Glossary word="Ethereum"></Glossary> Sepolia account in Ledger Live
...
*Fig. 1: Sepolia <Glossary word="Ethereum"></Glossary> Faucet*
...
In index.js copy-paste the following code and replace `{YOUR_INFURA_APIKEY}` by the <Glossary word="API"></Glossary> key you will find on your Infura account:
...
document.getElementById("connect-ledger").onclick = async function () {
    ...
    //Getting an <Glossary word="Ethereum"></Glossary> instance and get the Ledger Nano <Glossary word="ethereum"></Glossary> account public key
...
document.getElementById("tx-transfer").onclick = async function () {
    ...
    <Glossary word="nonce"></Glossary> =  await provider.getTransactionCount(addressWallet, "latest");

    //Building <Glossary word="transaction"></Glossary> with the information gathered
    const <Glossary word="transaction"></Glossary> = {
        to: recipient,
        gasPrice: "0x" + parseInt(gasPrice).toString(16),
        gasLimit: ethers.toBeHex(gasLimit),
        nonce: <Glossary word="nonce"></Glossary>,
        chainId: chainId,
        data: "0x00",
        value: ethers.toBeHex(ethers.parseUnits(value, "ether")),
    }

    //Serializing the <Glossary word="transaction"></Glossary> to pass it to Ledger Nano for signing
    ...
    //Serialize the same <Glossary word="transaction"></Glossary> as before, but adding the parsed signature on it
    ...
    //Sending the <Glossary word="transaction"></Glossary> to the blockchain
...
Before clicking on the text connect your Ledger to the USB port, unlock it and run the <Glossary word="ethereum"></Glossary> application.
...
<div className="center">
  <figure>
      <img src="/device-interaction/ledgerEth.jpg" alt="Run Ethereum Application on Ledger Nano"/>
    <figcaption><i>Fig. 7: Run <Glossary word="Ethereum"></Glossary> Application on Ledger Nano</i></figcaption>
  </figure>
</div>
...
<div className="center">
  <figure>
      <img src="/device-interaction/ledgerReady.jpg" alt="Ethereum Application is Running on Ledger Nano"/>
    <figcaption><i>Fig. 8:  <Glossary word="Ethereum"></Glossary> Application is Running on Ledger Nano</i></figcaption>
  </figure>
</div>
...
If all goes well, the input fields will be filled with data. The greyed input is not to be changed and it is directly extracted either from the <Glossary word="blockchain"></Glossary> or from your Ledger Embedded application.
...
Now that the inputs are filled with data. It is time to transfer some ether tokens from your Ledger <Glossary word="ethereum"></Glossary> account to another account (you can keep the default account on the "index.js" file).  
Therefore, click on "Create Transaction" to create the <Glossary word="transaction"></Glossary> which will be signed by your ledger before sending it to the <Glossary word="blockchain"></Glossary>.  

![Application After Connecting Ledger Nano](/device-interaction/tutorial-1-view2.png)
*Fig. 12: Application After Connecting Ledger Nano*

When the <Glossary word="transaction"></Glossary> proceed and finalize, an URL will be displayed on the screen. This URL is a link to Ropsten Etherscan to review the <Glossary word="transaction"></Glossary>.  
There you can find all the information concerning the <Glossary word="transaction"></Glossary> you have previously sent.

![Result after Sending Transaction](/device-interaction/tutorial-1-result.png)
*Fig. 13: Result after Sending Transaction*

If you go on Etherscan you can see the information of your <Glossary word="transaction"></Glossary>.

![Result after Sending Transaction](/device-interaction/tutorial-1-etherscan.png)
*Fig. 14: <Glossary word="Transaction"></Glossary> Information on Sepolia Etherscan*
