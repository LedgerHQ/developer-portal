...
In this <Glossary word="integration"></Glossary>, we will use the <Glossary word="ethereum"></Glossary> application.
...
class ShowAddressScreen extends Component {
  ...
  fetchAddress = async verify => {
    ...
    try {
      ...
      // in this case, user is likely not on <Glossary word="Ethereum"></Glossary> app
      if (this.unmounted) return;
      this.setState({ error });
      return null;
    }
  ...
  render() {
    ...
    return (
      <View style={styles.ShowAddressScreen}>
        {!address ? (
          <>
            <Text style={styles.loading}>Loading your <Glossary word="Ethereum"></Glossary> address...</Text>
            {error ? (
              <Text style={styles.error}>
                A problem occurred, make sure to open the <Glossary word="Ethereum"></Glossary> application
          ...
          <>
            <Text style={styles.title}>Ledger Live <Glossary word="Ethereum"></Glossary> Account 1</Text>
...
<div className="center">
  <figure>
    <img src="/device-interaction/adb-devices.png" alt="Device Connected On The Machine"/>
...
<div className="center">
  <figure>
    <Zoom>
      <img src="/device-interaction/mobile-install-app.jpg" alt="Mobile Application Installation"/>
    </Zoom>
...
<div className="center">
  <figure>
    <Zoom>
      <img src="/device-interaction/android-rn-ble.jpg" alt="Application Displayed on Smartphone"/>
    </Zoom>
...
<div className="center">
  <Zoom>
    <img src="/device-interaction/android-ble-error.jpg" alt="Bluetooth Not Authorized"/>
  </Zoom>
</div>
...
<div className="center">
  <figure>
    <Zoom>
      <img src="/device-interaction/android-settings-3.jpg" alt="App Settings 3"/>
    </Zoom>
...
<div className="center">
  <Zoom>
    <img src="/device-interaction/android-rn-ble-list.jpg" alt="Pairing the Ledger Nano X"/>
  </Zoom>
</div>
<br/>
<div className="center">
  <figure>
    <Zoom>
      <img src="/device-interaction/android-rn-pairing.jpg" alt="Pairing the Ledger Nano X"/>
    </Zoom>
...
<div className="center">
  <figure>
    <Zoom>
      <img src="/device-interaction/ledgerPairing.jpg" alt="Confirm the pairing"/>
    </Zoom>
...
<div className="center">
  <figure>
    ...
    <figcaption><i>Fig. 13: <Glossary word="Ethereum"></Glossary> Application</i></figcaption>
  </figure>
</div>
<br/>
<div className="center">
...
Now that the pairing is complete, the Nano X is ready with the <Glossary word="ethereum"></Glossary> application.
If all goes well you see the address of your <Glossary word="ethereum"></Glossary> account displayed.

<br/>
<div className="center">
  <figure>
    <Zoom>
      <img src="/device-interaction/android-rn-ble-address.jpg" alt="Address Account Displayed on Smartphone"/>
    </Zoom>
...
### Verify the Address
For security purposes, we display on your Nano X the same <Glossary word="ethereum"></Glossary> address for you to confirm.
...
<div className="center">
  <figure>
    <Zoom>
      <img src="/device-interaction/ledgerAddress.jpg" alt="Nano Verify Address Screen"/>
    </Zoom>
...
<div className="center">
  <figure>
    <Zoom>
      <img src="/device-interaction/ledgerApprove.jpg" alt="Device Approve Screen"/>
    </Zoom>
