...
This application will connect to your Ledger Nano X to display the address of your account (eg. bitcoin account, <Glossary word="ethereum"></Glossary> account). 
  ...
  render() {
    ...
    return (
      <div className={styles.ShowAddressScreen}>
        {!address ? (
          <>
            <p className={styles.loading}>Loading your <Glossary word="Ethereum"></Glossary> address...</p>
            {error ? (
          ...
          <>
            <strong>Ledger Live <Glossary word="Ethereum"></Glossary> Account 1</strong>
...
### Launch Ethereum App
Before clicking on the button, unlock it and run the <Glossary word="Ethereum"></Glossary> application.
...
<div className="center">
  <figure>
    <img src="/device-interaction/ledgerReady.jpg" alt="Embedded App is Running"/>
