...
- [Provider's Endpoints](./integration/providers-endpoints): details on the main endpoints needed for the swap.
- [Provider's LiveApp](./integration/providers-liveapp): details on the deeplink's format of your LiveApp.
- [Ledger's Exchange SDK](./integration/ledger-exchange-sdk): details on how to use the swap method of the Ledger's Exchange SDK to interact with Ledger Live.
