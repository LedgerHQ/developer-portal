...
- [LiveApp](swap/providers-liveapp): details on your LiveApp specifities, such as the widget URL, the Manifest or the use of Exchange SDK instead of the Wallet API.
