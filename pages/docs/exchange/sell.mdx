...
<Callout type="info" emoji="👉">
  Note that if you are a non-KYC exchange and don't specifically wish to keep an UI of your own, we can use a pure API integration and you can skip section 1.
</Callout>
...
- [LiveApp](sell/providers-liveapp): details on your LiveApp specifities, such as the widget URL, the Manifest or the use of Exchange SDK instead of the Wallet API.
