...
<Tabs items={['Swap', 'Sell', 'Buy', 'Fund']}>
  ...
  You will find all the information regarding those endpoints here: https://exchange-integration-swap.redoc.ly/, as well as additional details on some endpoints below. 
  ...
  **Float quote**: The quote price is indicative only, real price is computed at execution time
  ...
  You will find all the information regarding those endpoints here: https://exchange-integration-sell.redoc.ly/
  </Tabs.Tab>
  <Tabs.Tab>
