...
- To create a signed swap binary payload as Fixed trade method [/swap/fixed](https://exchange-integration-swap.redoc.ly/#operation/postSwapTradeFixed).
- To create a signed swap binary payload as Float trade method [/swap/float](https://exchange-integration-swap.redoc.ly/#operation/postSwapTradeFloat).
