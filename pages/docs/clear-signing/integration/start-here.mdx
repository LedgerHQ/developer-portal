...
| <b>A token developer</b> <br /> You're developing or maintaining ERC-20, ERC-721, or ERC-1155 tokens | [Token support guide](./token-support.mdx) | Verify the token is already supported or contact us for token support|


<Callout type="warning" emoji="⚠️">
    Some complex smart contracts or specialized use cases may require a [dedicated plugin](../../device-app/integration/how-to/plugin) (a device app) instead of just submitting metadata files to the registry. This is typically necessary for contracts with unusual execution patterns, non-standard data structures, or custom security requirements.
</Callout>
