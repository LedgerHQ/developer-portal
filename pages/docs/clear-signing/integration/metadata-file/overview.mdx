...
### Option A: Create Smart Contract Metadata
    ...
    - Recommended: [Use the ERC-7730 JSON Builder](./json-builder) for a guided experience
    - Alternative: Create the file manually following the [Smart Contract Metadata guidelines](./manual-creation)

### Option B: Create EIP-712 Metadata

Create your metadata file manually [using the EIP-712 template](./EIP712-message)
