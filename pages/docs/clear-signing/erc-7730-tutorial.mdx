...
# Tutorial: How to write a ERC-7730 JSON file
...
This is the example that we will write in this tutorial:
...
As you notice, there are three main sections in this file: `“context”`, `“metadata”` and `“display”`. We will deep dive into each of those sections to learn what their goal is, how to write them, and finally, how you can go further for more complex use cases.  
