...
In order to become a swap provider in the Ledger Live ecosystem, you must:
 ...
 3. Submit your Live App following [Ledger's specfication](../../../ledger-live/discover/non-dapp/introduction).
...
- [Ledger's Exchange SDK](./ledger-walletAPI-sdk): details on how to use the swap method of the Ledger's Exchange SDK to interact with Ledger Live. 
- [Test your LiveApp](./test): details on how to use the Ledger Live Developer Mode to test our LiveApp. 
