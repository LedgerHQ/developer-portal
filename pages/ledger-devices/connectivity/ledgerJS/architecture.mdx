...
<Cards num={2}>
  <Card
    ...
    href="/ledger-devices/connectivity/ledgerJS/architecture/application-architecture"
  />
  <Card
    title="Architecture dataflow"
    href="/ledger-devices/connectivity/ledgerJS/architecture/architecture-dataflow"
  />
</Cards>