...
<Callout emoji="💡">
  **Migration from Platform SDK:** If you are migrating from Platform SDK, please refer to [this section](./appendix/migration-guide) that will guide you through the process.
</Callout>
