...
See the complete submission flow [here](../submission-process/release-flow).
...
Ensure that you have a clear understanding of the [Process](../submission-process/release-flow) and are able to meet the [Requirements](../submission-process/release-requirements) listed here.
