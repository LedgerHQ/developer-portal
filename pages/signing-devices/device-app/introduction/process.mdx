...
See the complete submission flow [here](../process/release-flow).
...
Ensure that you have a clear understanding of the [Process](../process/release-flow) and are able to meet the [Requirements](../process/release-requirements) listed here.
