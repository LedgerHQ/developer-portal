...
- [**Ledger Extension (intro video)**](https://www.youtube.com/watch?v=YbsrsbodpzQ), that makes it easy to connect your Nano to Web3 directly from your browser, and also includes an advanced mechanism to verify the security of the DApp. See [Web3 Check](./web3-check/).
...
<Callout type="info" emoji="👉">
  <ul>
		...
		<li><a href='https://developers.ledger.com/docs/transport/overview/'>The Connect your App packages</a> will no longer be maintained.</li>
	</ul>
</Callout>
