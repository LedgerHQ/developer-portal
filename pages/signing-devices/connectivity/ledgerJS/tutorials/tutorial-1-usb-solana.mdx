...
## Prerequisites
Before startint, make sure you have gone through the [prerequisites](../integration-walkthrough/prerequisites/).

### Install the Solana Embedded App
First you need to install the Solana Embedded App from Ledger Live as shown in the [prerequisites](../integration-walkthrough/prerequisites/) for Ethereum.
