...
redirect_from: /docs/dapp/nano-plugin/testing
author:
toc: true
layout: doc
---
...
<!--  -->
{% include alert.html style="important" text="Our team is working on adapting the <a href='../../../embedded-app/framework/'>Ledger Framework</a> for Plugin development and testing. Until the framework is ready for plugins, follow the documentation below. This page will be updated when the framework is ready." %}
<!--  -->
