...
redirect_from: /docs/dapp/nano-plugin/overview
author:
toc: true
layout: doc
---
...
<!--  -->
{% include alert.html style="note" text="The second mandatory requirement to obtain official support by Ledger for your DApp is using a plugin to verify transaction details on the Ledger." %}
<!--  -->
