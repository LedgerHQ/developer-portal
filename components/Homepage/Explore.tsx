...
export const Explore = ({ journeyId }: ExploreProps) => {
  return (
    <div className="relative max-w-[1440px] bg-nano-background lg:bg-nano-background-lg xl:bg-nano-background-xl 2xl:bg-nano-background-2xl bg-cover md:bg-contain bg-no-repeat bg-[40%] md:bg-right bg-black">
