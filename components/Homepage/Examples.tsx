  ...
  return (
    <div className="relative bg-black">
      ...
      <div className="relative">
        <div className="absolute h-14 w-24 md:w-96 left-0 top-0 bg-black-gradient-left z-10" />
        <Carousel />
        <div className="absolute h-14 w-24 md:w-96 right-0 top-0 bg-black-gradient-right z-10" />
      </div>
